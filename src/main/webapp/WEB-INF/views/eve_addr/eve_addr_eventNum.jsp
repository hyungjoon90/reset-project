	...
	<div class="page_container">
						...
						<div class="panel-heading" role="tab" id="headingOne">
							<h4 class="panel-title">
								<a role="button" data-toggle="collapse" data-parent="#accordion"
									href="#collapse_${bean.add_no}" aria-expanded="true"
									aria-controls="collapseOne"> ${bean.add_no} : ${bean.name}
								</a>
							</h4>
						</div>
						<div id="collapse_${bean.add_no}" class="panel-collapse collapse"
							...
							<div class="panel-body">
								...
								<div>
									<label for="email">이메일 : </label> <span id="email" name="email">${bean.email}</span>
								</div>
								<div>
		...
		$("#extractionBtn").on("click",function(event){
			...
			$.ajax({
				...
				console.log(data);
				var str ="<a href='/reset/admin/eveaddr/download?text="+data+"'><span>"+data+"</span></a>";
